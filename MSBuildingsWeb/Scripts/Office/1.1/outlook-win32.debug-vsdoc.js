...
Office._$MailboxItem_helper = function (obj, appMode) {
    ...
    bodyDoc = {
        body_compose: {
            ...
            contents: function () {
                return new Office._context.mailbox.item.body()
            }
        },
        body_read_compose: {
            conditions: {
    ...
    itemTypeDoc = {
        ...
        itemType_read_compose: {
            conditions: {
                hosts: ["outlook, outlookcompose"]
            },
            name: "itemType",
            annotate: {
                ///<field name="itemType" type='Office.MailboxEnums.ItemType'> Gets the type of an item that an instance represents. In compose mode, the itemType field is undefined.</field>
                itemType: undefined
            }
        }
    }
    ...
    if (appMode == Office._appMode.Compose) {
        ...
        delete itemTypeDoc["itemType_read"];
        delete itemTypeDoc["itemType_read_compose"];
        ...
        delete itemClassDoc["itemClass_read_compose"];
        delete itemTypeDoc.itemType_read["conditions"];
        delete itemTypeDoc["itemType_read_compose"];
        ...
        delete itemTypeDoc["itemType_read"];
        delete itemTypeDoc.itemType_read_compose["conditions"];
        delete normalizedSubjectDoc["normalizedSubject_read"];
    ...
    Office._processContents(obj, itemTypeDoc);
